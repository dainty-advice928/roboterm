...
var q = class _q {
  ...
  static async load(A) {
    ...
    for (const C of g)
      try {
        return await _q.loadFromPath(C);
      } catch (I) {
  ...
  static async loadFromPath(A) {
    ...
    if (!B)
      try {
        const I = await (await import("./__vite-browser-external-2447137e-H3QRWOBL.js")).readFile(A);
...
var V = class {
  constructor(A) {
    ...
    this.encoder = E.getUint32(B, true), this.exports.ghostty_wasm_free_opaque(B);
  }
  setOption(A, B) {
  ...
  encode(A) {
    ...
    const E = new DataView(this.exports.memory.buffer), C = E.getUint32(B, true);
    ...
    const s = E.getUint32(i, true), N = new Uint8Array(this.exports.memory.buffer, D, s).slice();
...
var z = class K {
  constructor(A, B, g = 80, E = 24, C) {
    ...
    if (this.viewportBufferPtr = 0, this.viewportBufferSize = 0, this.cellPool = [], this.graphemeBuffer = null, this.graphemeBufferPtr = 0, this.exports = A, this.memory = B, this._cols = g, this._rows = E, C) {
      ...
      try {
        ...
        let w = D;
        i.setUint32(w, C.scrollbackLimit ?? 1e4, true), w += 4, i.setUint32(w, C.fgColor ?? 0, true), w += 4, i.setUint32(w, C.bgColor ?? 0, true), w += 4, i.setUint32(w, C.cursorColor ?? 0, true), w += 4;
        for (let s = 0; s < 16; s++)
          i.setUint32(w, ((I = C.palette) == null ? void 0 : I[s]) ?? 0, true), w += 4;
  ...
  parseCellsIntoPool(A, B) {
    ...
    for (let I = 0; I < B; I++) {
      ...
      i.codepoint = C.getUint32(D, true), i.fg_r = E[D + 4], i.fg_g = E[D + 5], i.fg_b = E[D + 6], i.bg_r = E[D + 7], i.bg_g = E[D + 8], i.bg_b = E[D + 9], i.flags = E[D + 10], i.width = E[D + 11], i.hyperlink_id = C.getUint16(D + 12, true), i.grapheme_len = E[D + 14];
    }
  }
  /**
...
var m = class {
  ...
  getLine(A) {
    ...
    if (this.bufferType === "normal" && A < g) {
      const D = A;
      E = B.getScrollbackLine(D), I = false;
    } else
...
var j = class {
  ...
  translateToString(A = false, B = 0, g = this._length) {
...
var v = class {
  ...
  isPositionInLink(A, B, g) {
    ...
    return B < E.y || B > C.y ? false : E.y === C.y ? A >= E.x && A <= C.x : B === E.y ? A >= E.x : B === C.y ? A <= C.x : true;
  }
  /**
...
var $ = class {
  constructor(A, B = {}) {
    ...
    const g = A.getContext("2d", { alpha: true });
    if (!g)
      throw new Error("Failed to get 2D rendering context");
    this.ctx = g, this.fontSize = B.fontSize ?? 15, this.fontFamily = B.fontFamily ?? "monospace", this.cursorStyle = B.cursorStyle ?? "block", this.cursorBlink = B.cursorBlink ?? false, this.theme = { ...f, ...B.theme }, this.devicePixelRatio = B.devicePixelRatio ?? window.devicePixelRatio ?? 1, this.palette = [
      this.theme.black,
      this.theme.red,
      this.theme.green,
      this.theme.yellow,
   ...
   */
  render(A, B = false, g = 0, E, C = 1) {
    var U;
    this.currentBuffer = A;
    const I = A.getCursor(), D = A.getDimensions(), i = E ? E.getScrollbackLength() : 0;
    (U = A.needsFullRedraw) != null && U.call(A) && (B = true), (this.canvas.width !== D.cols * this.metrics.width * this.devicePixelRatio || this.canvas.height !== D.rows * this.metrics.height * this.devicePixelRatio) && (this.resize(D.cols, D.rows), B = true), g !== this.lastViewportY && (B = true, this.lastViewportY = g);
...
`);
   ...
   */
  hasSelection() {
    return !this.selectionStart || !this.selectionEnd ? false : !(this.selectionStart.col === this.selectionEnd.col && this.selectionStart.absoluteRow === this.selectionEnd.absoluteRow);
  }
  /**
   * Clear the selection
   */
  ...
  attachEventListeners() {
    ...
    A.addEventListener("mousedown", (B) => {
      if (B.button === 0) {
        ...
        this.selectionStart = { col: g.col, absoluteRow: C }, this.selectionEnd = { col: g.col, absoluteRow: C }, this.isSelecting = true;
      }
      ...
      if (this.isSelecting) {
        this.isSelecting = false, this.stopAutoScroll();
      ...
      this.textarea.focus(), setTimeout(() => {
        ...
        document.addEventListener("click", E, { once: true }), document.addEventListener("contextmenu", E, { once: true }), this.textarea.addEventListener("blur", E, { once: true });
      }, 10);
...
var IA = class {
  ...
  constructor(A = {}) {
    this.unicode = {
      ...
      var g, E;
      this.renderer && this.wasmTerm && ((this.renderer.hoveredHyperlinkId || 0) > 0 && this.renderer.setHoveredHyperlinkId(0), this.renderer.setHoveredLinkRange(null)), this.currentHoveredLink && ((E = (g = this.currentHoveredLink).hover) == null || E.call(g, false), this.currentHoveredLink = void 0, this.element && (this.element.style.cursor = "text"));
    ...
    this.options = new Proxy(B, {
      set: (g, E, C) => {
        const I = g[E];
        return g[E] = C, this.isOpen && this.handleOptionChange(E, C, I), true;
      }
  ...
  open(A) {
    ...
    try {
      ...
      this.canvas.addEventListener("mousedown", (E) => {
        ...
        (E) => {
          var C;
          return ((C = this.wasmTerm) == null ? void 0 : C.getMode(E, false)) ?? false;
        }
      ...
      throw this.isOpen = false, this.cleanupComponents(), new Error(`Failed to open terminal: ${B}`);
    }
  }
  /**
...
`, B);
  ...
  resize(A, B) {
    ...
    this.canvas.width = g.width * A, this.canvas.height = g.height * B, this.canvas.style.width = `${g.width * A}px`, this.canvas.style.height = `${g.height * B}px`, this.resizeEmitter.fire({ cols: A, rows: B }), this.renderer.render(this.wasmTerm, true, this.viewportY, this);
  }
  /**
  ...
  fadeInScrollbar() {
    const A = Date.now(), B = () => {
      ...
      this.scrollbarOpacity = E, this.renderer && this.wasmTerm && this.renderer.render(this.wasmTerm, false, this.viewportY, this, this.scrollbarOpacity), E < 1 && requestAnimationFrame(B);
    };
    B();
  }
  /**
  ...
  fadeOutScrollbar() {
    const A = Date.now(), B = this.scrollbarOpacity, g = () => {
      ...
      this.scrollbarOpacity = B * (1 - C), this.renderer && this.wasmTerm && this.renderer.render(this.wasmTerm, false, this.viewportY, this, this.scrollbarOpacity), C < 1 ? requestAnimationFrame(g) : (this.scrollbarVisible = false, this.scrollbarOpacity = 0, this.renderer && this.wasmTerm && this.renderer.render(this.wasmTerm, false, this.viewportY, this, 0));
    };
    g();
  }
  /**
